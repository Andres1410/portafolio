		...
		<>
			<div class='p-4 text-left'>
				<div class='flow-root '>
					<div class='my-4 '>
						<strong>
							<p class='uppercase '>Política de privacidad</p>
						</strong>
						El sitio web Andres es propiedad de Andres, que es un controlador de
						datos de tus datos personales.
						<br />
						Hemos adoptado esta Política de privacidad, que determina cómo
						procesamos la información recopilada por Andres, que también
						...
						privacidad antes de usar el sitio web de Andres. <br />
						Cuidamos tus datos personales y nos comprometemos a garantizar su
						confidencialidad y seguridad.
						<br />
						<br />
						<strong>
							<p class='uppercase'>Información personal que recopilamos:</p>
						</strong>
						<br />
						Cuando visitas Andres, recopilamos automáticamente cierta
						...
						los productos que ves, qué sitios web o términos de búsqueda te
						remitieron al sitio y cómo interactúas con él. Nos referimos a esta
						información recopilada automáticamente como "Información del
						dispositivo". Además, podemos recopilar los datos personales que nos
						proporcionas (incluidos, entre otros, nombre, apellido, dirección,
						información de pago, etc.) durante el registro para poder cumplir
						con el acuerdo.
						<br />
						<br />
						<strong>
							<p class='uppercase'>¿Por qué procesamos tus datos?</p>
						</strong>
						<br />
						...
						no se agrega de tal manera que identifique a ningún usuario
						enparticular del sistema.
						<br />
						<br />
						...
						nombre, apellido, ciudad de residencia,
						<br />
						organización y número de teléfono. Puedes optar por no proporcionar
						tus datos personales, pero es posible que no puedas aprovechar
						algunas de las funciones del sitio web. Por ejemplo, no podrás
						recibir nuestro boletín ni contactarnos directamente desde el sitio
						web. Los usuarios que no estén seguros de qué información es
						obligatoria pueden ponerse en contacto con nosotros a través de
						andrescamcho6@gmail.com.
						<br />
						<br />
						<strong>Tus derechos:</strong>
						<br /> Si eres residente europeo, tienes los siguientes derechos
						...
						atento cuando abandones nuestro sitio web y leas las declaraciones
						de privacidad de cada sitio que pueda recopilar información
						personal.
						<br />
						<br />
						...
						<br />
						<br />
						<strong> Divulgación legal:</strong>
						<br />
						...
						puedes enviarnos un correo electrónico a andrescamcho6@gmail.com.
					</div>
				</div>
			</div>
		</>
